...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: BYMe 300x250 Ad Widget
...
if( ! class_exists( 'mts_ad_300_widget' ) ){
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('A widget for 300 x 250 ad (Single banner)', 'crypto' )
		);
		...
		// Create the widget
		parent::__construct( 'mts_ad_300_widget', sprintf( __('%s300 Ad', 'crypto' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ), $widget_ops, $control_ops );
