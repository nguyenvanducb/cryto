...
class MTS_RMU {
    ...
    private function __construct( $config = array() ) {
        $config_defaults = array(
            ...
            'link_label_install'      => __( 'Try it for FREE!', 'crypto' ),
            'link_label_activate'     => __( 'Click here to activate it.', 'crypto' ),

            // Add tab in MTS Theme Options.
            'add_theme_options_tab'   => true,
            'theme_options_notice'    => '<span style="display: block; line-height: 1.8; margin-bottom: 20px;">' . sprintf( __( '%1$s is a revolutionary SEO product that combines the features of many SEO tools. Its features give you the power of an entire SEO team with just a few clicks.', 'crypto' ), '<a href="https://BYMe.com/plugins/wordpress-seo-plugin/?utm_source=Theme+Options+Panel&utm_medium=Link+CPC&utm_content=Rank+Math+SEO+LP&utm_campaign=UserBackend" target="_blank">Rank Math SEO</a>' ) . ' @CTA' . '</span>',
            ...
            'metabox_notice_install'  => sprintf( __( 'The new %1$s plugin will help you rank better in the search results.', 'crypto' ), '<a href="https://BYMe.com/plugins/wordpress-seo-plugin/?utm_source=SEO+Meta+Box&utm_medium=Link+CPC&utm_content=Rank+Math+SEO+LP&utm_campaign=UserBackend" target="_blank">Rank Math SEO</a>' ) . ' @CTA',

            /* Translators: %s is CTA, e.g. "Try it now!" */
            'metabox_notice_activate' => sprintf( __( 'The %1$s plugin is installed but not activated.', 'crypto' ), '<a href="https://BYMe.com/plugins/wordpress-seo-plugin/?utm_source=SEO+Meta+Box&utm_medium=Link+CPC&utm_content=Rank+Math+SEO+LP&utm_campaign=UserBackend" target="_blank">Rank Math SEO</a>' ) . ' @CTA',
    ...
    public function dashboard_widget_output( $post, $callback_args ) {
        ...
        ?>
            <div class="rmu-dashboard-panel">
                <a class="rmu-dashboard-panel-close" id="rmu-dashboard-dismiss" href="http://schema.local/wp-admin/?rmu-dashboard=0""><?php _e( 'Dismiss', 'crypto' ); ?></a>
    ...
    public function get_install_link( $class = '', $label = '' ) {
        ...
        return '<a href="' . $install_link . '" class="thickbox ' . esc_attr( $class ) . '" title="' . esc_attr__( 'Rank Math SEO', 'crypto' ) . '">' . $label . '</a>';
    }
    ...
    public function add_theme_options_seo_tab( $sections ) {
        ...
        $sections[] = array(
            ...
            'title'  => __( 'SEO', 'crypto' ),
            'desc'   => '<p class="description">' . __( 'Fix all your SEO issues with just a few clicks. Comply with all the latest Google’s guidelines.', 'crypto' ) . '</p>',
            'fields' => array(
                'seo_message' => array(
                    'id'    => 'mts_seo_message',
                    'type'  => 'info',
                    'title' => '<a href="https://BYMe.com/plugins/wordpress-seo-plugin/?utm_source=Theme+Options+Panel&utm_medium=Link+CPC&utm_content=Rank+Math+SEO+LP&utm_campaign=UserBackend" target="_blank" class="rm-logo">' . $this->get_logo_svg() . '</a>',
                    'desc'  => strtr( $this->get_setting( 'theme_options_notice' ), array( '@CTA' => $this->get_install_or_activate_link() ) ) . $didyouknow . $this->get_install_or_activate_link( 'button button-primary', __( 'Install Now', 'crypto' ), __( 'Activate It', 'crypto' ) ) . $this->get_notice_css(),
                ),
            ),
        );
        return $sections;
    ...
    public function filter_plugins_popup( $result, $action, $args ) {
        ...
        $information->author                  = '<a href="https://BYMe.com/">BYMe</a>';
        $information->homepage                = 'https://BYMe.com/plugins/wordpress-seo/';
        $information->requires                = '4.2';
        $information->requires_php            = '5.6';
        $information->banners                 = array( 'low' => 'https://BYMe.com/rm-4-file/rank-math-banner.jpg' );
        $information->sections                = array();
        $information->sections['description'] = $this->get_plugin_description();
        // Changelog.
        $response = wp_remote_get( 'https://BYMe.com/changelog/rank-math/' );
...
<p><strong>SEO is the most consistent source of traffic for any website.</strong> We created <a href="https://BYMe.com/plugins/wordpress-seo/"><strong>Rank Math, a WordPress SEO plugin</strong></a>, to help every website owner get access to the SEO tools they need to improve their SEO and attract more traffic to their website.</p>

<p><a href="https://BYMe.com/plugins/wordpress-seo/#rank-math-features">Features</a> | <a href="https://BYMe.com/plugins/wordpress-seo/#why-rank-math">Why Choose Rank Math?</a> | <a href="https://BYMe.com/plugins/wordpress-seo/#seo-comparison">Compare</a> | <a href="https://BYMe.com/plugins/wordpress-seo/#seo-screenshots">Screenshots</a> | <a href="https://BYMe.com/plugins/wordpress-seo/#rank-math-benefits">Benefits</a></p>
...
<p>Its host of <strong>intelligent features</strong> brings SEO capabilities in your hands that were previously out of reach. The <strong>smart automation</strong> features give you the <strong>power of an entire SEO team</strong> with just a few clicks. A well thought out design, powerful features, and <strong>years of development</strong> by the BYMe squad makes Rank Math a game-changing SEO plugin that will level the SEO playing field in your favor.</p>
...
<p><a href="https://www.dotcomonly.com/rankmath-seo-plugin/">Rank Math: An SEO Plugin by BYMe Review + Setup Guide</a></p>
...
<p>= Getting Started: =
<strong><a href="https://BYMe.com/kb/product/wordpress-seo-plugin-rank-math/">1. User Documentation:</a></strong> Although Rank Math is already easy to setup, but we\'ve put together tutorials, guides, and some knowledge bases to help you set up and get started with Rank Math.</p>

<p><strong><a href="https://BYMe.com/kb/wordpress-seo-plugin-rank-math/xml-sitemaps/">2. Developer Docs:</a></strong> We\'ve created an in-depth documentation for developers and technical users who would like to look under the hood and extend or modify Rank Math for themselves.</p>

<p><strong><a href="https://BYMe.com/kb/wordpress-seo-plugin-rank-math/installing-with-ftp/">3. Fixing Common Errors:</a></strong> Sometimes avoidable or common issues can get you stuck. We\'ve created a common guide where we discuss all the common issues and how to fix them.</p>

<p><strong><a href="https://community.BYMe.com/forum/23-rank-math-free/">4. Support Ticket Forum:</a></strong> Our dedicated forum is where you can get support for any issues that you face with Rank Math. In the forum, we\'ll also try to answer some SEO queries. User experience is important to us and our aim is to answer all the queries on the forum in a timely manner.</p>

<p><strong><a href="https://BYMe.com/kb/">5. Frequently Asked Questions:</a></strong> Here we\'ve answered the most commonly asked questions about Rank Math. The questions are related to features, pricing, and others.</p>
';
    }
